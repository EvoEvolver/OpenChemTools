...
@toolset.add()
def geometry_optimization(atoms: List[Tuple[str, List[float]]], basis: str = "6-31g", xc: str = "b3lyp") -> Dict[
    str, Any]:
    """
...
def frequency_calculation(atoms: List[Tuple[str, List[float]]], basis: str = "6-31g", xc: str = "b3lyp") -> Dict[
    str, Any]:
    """
